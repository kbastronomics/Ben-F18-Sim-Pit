...
DES_CAB_ALT = map(newValue, 0, 65000, 0, 720);
}
...
//DcsBios::ServoOutput CABaltOffFlag(0x751c,A4, 1395, 1940); //happy

void setup(){
 myservo.attach(A4);
 myservo.writeMicroseconds(1395);  // set servo to "Off Point"
delay(500);
myservo.writeMicroseconds(1940);  // set servo to "On Point"
delay(500);
myservo.detach();
//###########################################################################################
...
pos = 0;
//DES_CAB_ALT = map(0, 0, 65000, 0, 720);
/// CAB ALT WORKING ======< SET CABAR ALT STEPPER TO 0 FEET
