...
#define ALT_OFFSET_TO_ZERO_POINT 720
...
// #define  COIL_STANDBY_ALT_A1  44 // STANDBY ALT
// #define  COIL_STANDBY_ALT_A2  42
// #define  COIL_STANDBY_ALT_A3  38
// #define  COIL_STANDBY_ALT_A4  40

#define  COIL_STANDBY_ALT_A1  44 // STANDBY ALT
#define  COIL_STANDBY_ALT_A2  42
#define  COIL_STANDBY_ALT_A3  40
#define  COIL_STANDBY_ALT_A4  38
    ...
    virtual void loop() {
      ...
      if (initState == 2) { // zeroing
        if (!SARIzeroDetected()) {
          ...
          stepper.runToNewPosition(stepper.currentPosition() + SARIzeroOffset);
...
// #define  COIL_AIRSPEED_A2  15
// #define  COIL_AIRSPEED_A3  16
// #define  COIL_AIRSPEED_A4  17

#define  COIL_AIRSPEED_A1  1
#define  COIL_AIRSPEED_A2  14
#define  COIL_AIRSPEED_A3  16
#define  COIL_AIRSPEED_A4  17
...
// Going in the incorrect direction
 ...
 #define  COIL_VVI_A2  32
 #define  COIL_VVI_A3  34
 #define  COIL_VVI_A4  36

//#define  COIL_VVI_A1  30
//#define  COIL_VVI_A2  32
//#define  COIL_VVI_A3  36
//#define  COIL_VVI_A4  34
...
void loop() {
  ...
  //###########################################################################################
  /*
    if (valSARI_ROLL > posSARI_ROLL) {
      stepperSTANDBY_SARI_ROLL.step(1);      // move one step to the left.
      posSARI_ROLL++;
      // SendDebug(String(valVVI) + " Inc VVI " + String(posVVI));
    }
    else if (valSARI_ROLL < posSARI_ROLL) {
      stepperSTANDBY_SARI_ROLL.step(-1);       // move one step to the right.
      posVVI--;
