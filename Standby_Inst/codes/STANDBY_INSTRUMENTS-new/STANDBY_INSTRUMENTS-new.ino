...
#define NUM_LEDS_CHA 8 // Generic Backlight loop - SPARE (100 LEDS) Change as required
#define DATA_PIN_CHA 3 // ARDUINO PIN that SPARE is connected to
...
#define ALT_OFFSET_TO_ZERO_POINT 820
...
#define AIRSPEED_OFFSET_TO_ZERO_POINT 715
...
#define VVI_OFFSET_TO_ZERO_POINT 385
...
DcsBios::RotaryEncoder stbyPressAlt("STBY_PRESS_ALT", "-800", "+800", 46, 48);
DcsBios::Switch2Pos saiTestBtn("SAI_TEST_BTN", A12);
DcsBios::Switch2Pos saiCage("SAI_CAGE", A13);
...
void setup() {
  ...
  //fill_solid(leds_A, NUM_LEDS_CHA, CRGB::DarkSeaGreen);
  //fill_solid(leds_A, NUM_LEDS_CHA, CRGB::FloralWhite);
  //fill_solid(leds_A, NUM_LEDS_CHA, CRGB::ForestGreen);
  //fill_solid(leds_A, NUM_LEDS_CHA, CRGB::DarkGreen);
  //fill_solid(leds_A, NUM_LEDS_CHA, CRGB::Chartreuse);
  fill_solid(leds_A, NUM_LEDS_CHA, CRGB::Green);


  FastLED.setBrightness(150); // SET INSTRUMENT BRIGHTNESS (0 to 255)
